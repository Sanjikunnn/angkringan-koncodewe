...
<head>
    <title>Checkout - Koncodewe</title>
...
<body>
    ...
    <section class="orders">
        <div class="container w-75" data-aos="fade-up">
            ...
            <p>
                Silahkan Anda memeriksa kembali daftar pesanan Anda pada bagian struk.
                Jika telah sesuai silakan Lakukan Pembayaran.
                ...
                <div class="col-lg-7 d-flex align-items-stretch">
                    ...
                    <div class="info">
                        ...
                        <table class="table mt-3">
                            ...
                            <tr>
                                <th colspan="4">
                                    Jumlah Menu: {{ $data['total_item'] }} pcs
                                </th>
                            </tr>
                            <tr>
                                <th></th>
                ...
                <div class="col-lg-5 mt-5 mt-lg-0 d-flex align-items-stretch">
                    <form action="{{ route('orders.pay', $data['carts_id']) }}" method="POST" class="php-email-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="date" value="{{ $today }}" class="form-control" id="date" readonly required />
                        </div>
                        <div class="form-row">
