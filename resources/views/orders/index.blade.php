            ...
            <div class="row">
                <div class="col-lg-12 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1">
                    <div class="content">
                        ...
                        <p>
                            Halaman Pesanan ini digunakan untuk memantau status pesanan anda setelah melakukan pembayaran.
                        </p>
                    </div>
                    ...
                    <section id="product" class="product pt-3">
                                        ...
                                        <div class="form-check col-12 m-2 mb-0">
                                            <label class="form-check-label col-12">
                                                <a data-toggle="collapse" class="collapsed" href="#accordion-list-{{ $order->id }}">
                                                    ...
                                                    @endforeach
                                                    Berstatus: <span>{{ $order->status }}</span><br>
                                                    @if ($order->status == 'siap')
                                                    <span>Silahkan ke Kasir untuk mengambil pesanan Anda</span><br>
                                                    @endif
                        ...
                        <div class="content">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th>Siap</th>
                                    <td>pesanan telah siap dan Pelanggan bisa mengambil pesanan di kasir</td>
                                </tr>
                                <tr>
                                    <th>Selesai</th>
