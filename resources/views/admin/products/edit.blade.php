...
<main>
    <div class="container-fluid">
        <h1 class="mt-4">Halaman Edit Menu</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Halaman untuk edit menu {{ $data['product']->name }}</li>
        </ol>
        <div class="card mb-4">
            <div class="card-header">
                <h4>
                    ...
                    <div class="float-right">
                        <a class="btn btn-secondary btn-sm" href="{{ route('products.index') }}">Kembali</a>
                    </div>
                </h4>
            </div>
            <div class="card-body">
                <form action="{{ route('products.update', $data['product']->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" id="name" name="name" type="text" placeholder="Masukkan nama menu" value="{{ $data['product']->name }}" required />
                    </div>
                    <div class="form-group">
