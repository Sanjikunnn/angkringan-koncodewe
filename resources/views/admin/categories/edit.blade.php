...
@section('title', 'Edit Kategori Menu Koncodewe- Admin')

@section('content')

<main>
    <div class="container-fluid">
        <h1 class="mt-4">Halaman Edit Kategori</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Halaman untuk edit Kategori {{ $category->name }}</li>
        </ol>
        <div class="card mb-4">
            <div class="card-header">
                <h4>
                    ...
                    <div class="float-right">
                        <a class="btn btn-secondary btn-sm" href="{{ route('categories.index') }}">Kembali</a>
                    </div>
                </h4>
            </div>
            <div class="card-body">
